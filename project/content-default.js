...
window.CONTENT = {
  "seo": {
    "title": "Даниил Карацапов — интернет-маркетолог | Контекст, таргет, сайты",
    "description": "Частный интернет-маркетолог Даниил Карацапов. Контекстная реклама, таргет, разработка сайтов. Работаю лично, отвечаю за результат."
  },
  "hero": {
    ...
    "titleLine2": "делаю",
    "titleAccent": "я сам",
    "sub": "Помогаю малому и среднему бизнесу привлекать клиентов через интернет. Без посредников, без анонимных команд и пустых отчётов.",
  ...
  "about": {
    ...
    "paragraphs": [
      "Почти 10 лет я занимаюсь интернет-маркетингом. Каждый проект веду лично — от аудита до результата. Работаю с малым бизнесом, стартапами и локальными компаниями по всей России.",
      "Никаких «наших специалистов» и менеджеров-посредников. Вы всегда знаете, кто делает вашу рекламу и почему она работает именно так. Я отвечаю за результат лично."
    ],
    "chips": [
      "Вся Россия, онлайн",
  ...
  "servicesHead": {
    "eyebrow": "Что я делаю",
    "heading": "Пять направлений.\nОдин ответственный — я",
