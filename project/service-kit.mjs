...
const ALL = [
  ['/kompleksnyj-marketing/', 'Маркетинг под ключ', 'Трафик, посадочная и аналитика в одних руках, одна точка ответственности.', 'от 90 000 ₽/мес'],
  ...
  ['/targetirovannaya-reklama/', 'Таргетированная реклама', 'VK Ads и Telegram Ads там, где аудитория не ищет, но проводит время.', 'от 18 000 ₽/мес'],
  ...
  ['/skvoznaya-analитика/', 'Сквозная аналитика', 'Связка рекламы, звонков и CRM: видно деньги, а не клики.', 'от 12 000 ₽/мес'],
