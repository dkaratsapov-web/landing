...
export const meta = {
  ...
  description: 'Веду интернет-маркетинг целиком: реклама, посадочная страница и сквозная аналитика в одних руках. Один ответственный вместо трёх подрядчиков, которые кивают друг на друга. От 65 000 ₽ в месяц.',
...
${l.works.map((w) => `          <li>${w}</li>`).join('\n')}
  ...
  const body = `${hero({
    ...
    factList: [
      ['от 65 000 <span>₽</span>', 'в месяц, фиксированно'],
