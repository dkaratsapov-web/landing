...
export function render() {
  ...
  /* Крошки ведут в «Кейсы», а не в «Разработку сайтов»: это кейс, и лежит он
     теперь там же, где остальные двадцать два. Раньше страница жила внутри
     раздела услуги, и путь к ней получался неочевидным — из витрины кейсов
     человек уходил в другой раздел и терял контекст. */
  const crumbs = breadcrumbs([['/keysy/', 'Кейсы'], [meta.path, 'Сайт бюро «Сфера»']]);
