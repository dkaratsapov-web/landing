...
function HeroTrust() {
  ...
  return (
    /* Классы обязательны: под них написана мобильная раскладка в landing.css.
       Без них три показателя переносились как придётся — два в ряд и третий
       один на строке, будто вёрстка не доехала. */
...
const HERO_SUB = 'Привлекаю клиентов через интернет — от локального бизнеса до крупных проектов с сетью филиалов. Без посредников, без анонимных команд и пустых отчётов.';
