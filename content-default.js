...
window.CONTENT = {
  "seo": {
    ...
    "description": "Частный интернет-маркетолог Даниил Карацапов: контекстная реклама в Яндекс Директ, таргет VK Ads, сайты и сквозная аналитика. В digital с 2019 года. Ведение от 30 000 ₽/мес.",
    "ogTitle": "Даниил Карацапов — частный интернет-маркетолог",
    "ogDescription": "Контекстная реклама, таргет VK Ads, сайты и аналитика. В digital с 2019 года, 70+ ниш с измеримым результатом. Работаю лично, без агентских наценок."
  },
  "hero": {
    "eyebrow": "Даниил Карацапов · интернет-маркетолог",
    "titleLine1": "Интернет-маркетинг,",
    "titleLine2": "который делаю",
    "titleAccent": "я сам",
    "sub": "Привлекаю клиентов через интернет — от локального бизнеса до крупных проектов с сетью филиалов. Настраиваю Яндекс Директ, VK Ads, делаю сайты — лично, без посредников и пустых отчётов.",
    ...
    "trust": [
      ...
      [
        "264–520%",
        "ROI по опубликованным кейсам"
      ]
    ]
  },
  "about": {
    "eyebrow": "Обо мне",
    "heading": "Частный интернет-маркетолог,\nа не агентство",
    "paragraphs": [
      "Со мной вы получаете одного исполнителя на весь маркетинг: тот же человек разбирает нишу, настраивает кампании, собирает сайт и объясняет цифры в отчёте. Ничего не теряется на передаче между отделами, и спрашивать за результат нужно с одного.",
      "Никаких агентских наценок, «наших специалистов» и менеджеров-посредников. Вы всегда знаете, кто настраивает вашу рекламу и почему она работает именно так."
    ],
    "chips": [
    ...
    "stats": [
      {
        "value": 7,
        "suffix": "+",
        "label": "лет в digital-маркетинге"
      },
      {
        "value": 22,
        "suffix": "",
        "label": "кейса с измеримым результатом"
      },
      {
        "value": 3,
        "suffix": "+ млн ₽",
        "label": "оборот кабинетов в месяц"
      },
      {
        "value": 9,
        "suffix": "",
        "label": "сертификатов Яндекса и Google"
      }
    ]
  },
  "servicesHead": {
    "eyebrow": "Что я делаю",
    "heading": "Услуги интернет-маркетинга:\nреклама, сайты, аналитика",
  ...
  "services": [
    ...
    },
    {
      ...
      "price": "сопровождение от 12 000 ₽/мес"
    },
    {
      "icon": "IconLayers",
      ...
      "price": "от 65 000 ₽/мес · зависит от объёма работ"
    }
  ],
  "processHead": {
  ...
  "casesHead": {
    ...
    "heading": "Кейсы: результаты\nрекламных кампаний в цифрах",
  ...
  "cases": [
    {
      ...
      "summary": "Продвижение ресторана премиум-класса на Садовом кольце у Патриарших прудов. Стабильный поток броней, рост среднего чека и полный контроль окупаемости рекламы.",
      "metrics": [
        [
          "+64%",
    ...
    },
    {
      ...
      "summary": "Продвижение производства премиальной мебели из массива дерева. Точечная работа с платёжеспособной аудиторией и рост доли целевых заявок.",
      "metrics": [
        [
          "+57%",
          "целевых заявок за 3 месяца"
        ],
        [
          "ROI 264%",
          "окупаемость рекламы"
    ...
    },
    {
      ...
      "summary": "Комплексный запуск и продвижение нового караоке-клуба: сайт с онлайн-бронированием, реклама и сквозная аналитика.",
      "metrics": [
        [
          "+78%",
          "заявок за первые 2 месяца"
    ...
    },
    {
      ...
      "summary": "Комплексная стратегия digital-продвижения для многопрофильного медицинского центра: рост онлайн-записей и контроль рекламных расходов.",
      "metrics": [
        [
          "+120%",
          "записей на приём"
        ...
        [
          "55%",
          "онлайн-записей через Яндекс Бизнес"
        ],
        [
          "−28%",
          "неэффективных расходов на рекламу"
        ]
      ]
    }
  ],
  "certsHead": {
    ...
    "heading": "Сертификаты Яндекса и Google",
  ...
  "contacts": {
    "eyebrow": "Контакты",
    "heading": "Заказать интернет-маркетинг под ключ",
    ...
    "reply": "Отвечаю в течение часа",
    "hours": "Пн–Пт 10:00–21:00 · Сб–Вс 10:00–16:00",
