...
window.CONTENT = {
  "seo": {
    "title": "Даниил Карацапов — маркетолог | Контекстная реклама, таргет, GEO-продвижение",
    "description": "Маркетолог с 9+ лет опыта. Контекстная реклама в Яндекс Директ, таргет VK Ads, продвижение в Яндекс Картах. Работаю лично — без посредников. Заявки с первой недели.",
    "ogTitle": "Даниил Карацапов — маркетолог",
    "ogDescription": "Контекстная реклама, таргет VK Ads, GEO-продвижение. 9+ лет, 70+ ниш. Без посредников, результат с первой недели."
  },
  "hero": {
  ...
  "cases": [
    ...
    },
    {
      ...
      "tags": ["site", "context", "geo", "target", "analytics"],
      "services": ["Сайт", "Яндекс Директ", "VK Ads", "Яндекс Бизнес", "Сквозная аналитика"],
    ...
    },
    {
      ...
      "tags": ["context", "geo", "target", "analytics"],
